...
legend('Unclassified','Intermediate-Shallow, Clayey Loam to Sandy Loam, Mudstone and Sandstone','Shallow, Loam to Sandy Loam, Sandstone','Deep, Riverine clay: Sands and Gravels, Clay to Sandy Loam','Deep, River Terrace: Sand gravel, Sandy Loam','Shallow Mining');
xlabel('Seasonality Index');
ylabel('Normalised Histogram Freq');
