function seasVsRMSEPaper

load outputList2;
load interpLocationNormAC 
arrayAC2 = interpLocation.arrayAC2;

arrayVar = var(interpLocation.outcdTSmooth');
arrayVar = max(interpLocation.outcdTSmooth')-min(interpLocation.outcdTSmooth');
...
arrayVar = arrayVar(ouputList2+1);
...
thisPlot(arrayAC2, l8In(:,9)', 1, 'Seq2Seq4');
thisPlot(arrayAC2, l9In(:,9)', 2, 'SARIMA');
thisPlot(arrayAC2, l10In(:,9)', 3 , 'SINU');

save tmp
%thisPlot(arrayAC2, l8In(:,9)'./arrayVar, 1, 'Seq2Seq4');
%thisPlot(arrayAC2, l9In(:,9)'./arrayVar, 2, 'SARIMA');
%thisPlot(arrayAC2, l10In(:,9)'./arrayVar, 3 , 'SINU');

function thisPlot(xx, yy , num, titley)
