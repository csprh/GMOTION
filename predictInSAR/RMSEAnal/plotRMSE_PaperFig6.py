...
def showPlot(thisPos, plotName, plotTitle, normal):
    ...
    thisfig = plt.figure(figsize=(12,9))
...
showPlot(0,'1MonthNormalCon.pdf','Prediction of 1 Month (Seasonal)',0)
#showPlot(4,'5Month.pdf','Prediction of 5 Month')
showPlot(8,'9MonthNormalCon.pdf','Prediction of 9 Month (Seasonal)',0)
showPlot(0,'1MonthNotNormal.pdf','Prediction of 1 Month (Seasonal)',1)
#showPlot(4,'5Month.pdf','Prediction of 5 Month')
showPlot(8,'9MonthNotNormal.pdf','Prediction of 9 Month (Seasonal)',1)
